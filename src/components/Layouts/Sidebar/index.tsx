...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {/* Sidebar */}
      <div
        className={`fixed top-0 left-0 w-full md:w-80 h-screen bg-white border-r border-gray-200 md:relative md:flex md:flex-col md:justify-between md:max-w-xs z-50 ${
